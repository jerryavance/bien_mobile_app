...
//   Widget _buildSpendingTab() {
//     final categories = [
//       {'name': 'Food & Dining', 'amount': 487.50, 'percentage': 15.0, 'color': AppTheme.warningColor},
//       {'name': 'Transportation', 'amount': 324.80, 'percentage': 10.0, 'color': AppTheme.infoColor},
//       {'name': 'Entertainment', 'amount': 298.45, 'percentage': 9.2, 'color': AppTheme.accentColor},
//       {'name': 'Shopping', 'amount': 256.90, 'percentage': 7.9, 'color': AppTheme.primaryColor},
//       {'name': 'Utilities', 'amount': 198.75, 'percentage': 6.1, 'color': AppTheme.secondaryColor},
//       {'name': 'Healthcare', 'amount': 156.30, 'percentage': 4.8, 'color': AppTheme.successColor},
//     ];
...
//           _buildIncomeItem('Salary', 'UGX 4,200', 'Primary Income', AppTheme.successColor),
//           _buildIncomeItem('Freelance', 'UGX 1,800', 'Side Projects', AppTheme.primaryColor),
//           _buildIncomeItem('Investment Returns', 'UGX 1,420', 'Portfolio Growth', AppTheme.secondaryColor),
//           _buildIncomeItem('Other', 'UGX 1,000', 'Miscellaneous', AppTheme.accentColor),
...
//           _buildSavingsGoal('Emergency Fund', 5000, 3200, AppTheme.successColor),
//           _buildSavingsGoal('Vacation Fund', 3000, 1800, AppTheme.accentColor),
//           _buildSavingsGoal('Home Down Payment', 50000, 15000, AppTheme.primaryColor),
...
//   Widget _buildIncomeItem(String source, String amount, String description, Color color) {
//     return Container(
//       margin: const EdgeInsets.only(bottom: 12),
//       padding: const EdgeInsets.all(16),
//       decoration: BoxDecoration(
...
//           Text(
//             'UGX ${current.toStringAsFixed(0)} of UGX ${target.toStringAsFixed(0)}',
//             style: AppTheme.bodySmall.copyWith(
//               color: AppTheme.textSecondary,
//             ),
//           ),
